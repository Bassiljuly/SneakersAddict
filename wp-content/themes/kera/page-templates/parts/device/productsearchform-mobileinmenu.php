<?php if ( kera_tbay_get_config('show_searchform') ): ?>
	...
	<?php 
		...
		$enable_search_category 	=  kera_tbay_get_config('mobile_enable_mobile_search_category', true);
		...
		$options 					=  apply_filters( 'kera_search_in_options', 10,2 );


		$search_text_categories 	=  kera_tbay_get_config('search_text_categories', esc_html__('All categories', 'kera'));
		$search_placeholder 		=  kera_tbay_get_config('mobile_search_placeholder', esc_html__('Search for products...', 'kera'));

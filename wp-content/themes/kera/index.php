...
<?php
	...
	$class_row = ( ( $blog_archive_layout === 'main-right') || ( $blog_single_layout === 'main-right' ) ) ? 'flex-row-reverse' : '';

	kera_tbay_render_breadcrumbs();

	$class_main = apply_filters('kera_tbay_post_content_class', 'container');
	...
	<section id="main-container" class="main-content  <?php echo esc_attr($class_main); ?>">
		...
		<?php do_action( 'kera_post_template_main_container_before' ); ?>
		...
		<div class="row <?php echo esc_attr($class_row); ?>">
			...
			<div id="main-content" class="col-sm-12 <?php echo esc_attr($sidebar_configs['main']['class']); ?>">
				<main id="main" class="site-main layout-blog">
					...
					<?php do_action( 'kera_post_template_main_content_before' ); ?>
					...
					<?php do_action( 'kera_post_template_main_content_after' ); ?>
		...
		<?php do_action( 'kera_post_template_main_container_after' ); ?>
	</section> 
	<?php

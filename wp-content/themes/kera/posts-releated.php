<?php
    ...
    $relate_count = kera_tbay_get_config('number_blog_releated', 2);
    $relate_columns = kera_tbay_get_config('releated_blog_columns', 2);
...
?>
    <div class="tbay-addon tbay-addon-blog relate-blog">
        <h4 class="tbay-addon-title">
            <span><?php esc_html_e( 'Related posts', 'kera' ); ?></span>
        </h4>
        ...
        <div class="tbay-addon-content">
            ...
            ?>
            <div class="owl-carousel rows-1" data-carousel="owl" data-navleft="icon-arrow-left" data-navright="icon-arrow-right" data-items="<?php echo esc_attr($relate_columns); ?>" data-nav="<?php echo esc_attr($nav_type); ?>" data-pagination="<?php echo esc_attr($pagi_type); ?>" data-desktopslick="<?php echo esc_attr($relate_columns); ?>" data-desktopsmallslick="<?php echo esc_attr($relate_columns); ?>" data-tabletslick="2" data-landscapeslick="2" data-mobileslick="1">
            <?php

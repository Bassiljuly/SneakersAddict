...
if ( $cross_sells ) : ?>
	...
	<div class="cross-sells related products tbay-element tbay-element-product">
         <?php
		$heading = apply_filters( 'woocommerce_product_cross_sells_products_heading', esc_html__( 'You may be like', 'kera' ) );

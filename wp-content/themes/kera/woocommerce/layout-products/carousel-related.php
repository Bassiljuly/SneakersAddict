...
?>
<div class="owl-carousel products related row-1 <?php kera_slick_carousel_product_block_image_class(); ?>" <?php echo trim($responsive_carousel); ?>  <?php echo trim($data_carousel); ?> >

            ...
            foreach ($product_tabs as $key => $product_tab): $in = ( $i == 0 ) ? 'show' : '';
                ...
                <div class="panel">
                    ...
                    <div class="tabs-title" id="tbay-wc-tab-<?php echo esc_attr( $key ); ?>">
                      <h5 class="mb-0">
                        <button class="btn btn-link" data-toggle="collapse" data-target="#collapse-tab-<?php echo esc_attr( $i ); ?>" aria-expanded="true" aria-controls="collapse-tab-<?php echo esc_attr( $i ); ?>">
                        <?php echo apply_filters( 'woocommerce_product_' . $key . '_tab_title', esc_html( $product_tab['title'] ), $key ); ?>
                        <i class="tb-icon tb-icon-<?php echo esc_attr( $arrow ); ?>-square icons"></i>
                        </button>
                      </h5>
                    </div> 

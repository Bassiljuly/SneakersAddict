...
get_header();
$sidebar_configs = kera_tbay_get_page_layout_configs();
...
<section id="main-container" class="<?php echo apply_filters('kera_tbay_page_content_class', 'container');?>">

...
if ( !function_exists('kera_before_render_sticky_header')) {
    function kera_before_render_sticky_header( $widget ) {
    ...
    add_action('elementor/frontend/section/before_render', 'kera_before_render_sticky_header', 10, 2 );
}

...
if ( !function_exists('kera_render_element_child_border')) {
    function kera_render_element_child_border( $widget ) {
    ...
    add_action('elementor/frontend/column/before_render', 'kera_render_element_child_border', 10, 2 );
}

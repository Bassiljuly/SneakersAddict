...
if ( !function_exists('kera_section_stretch_row')) {
    function kera_section_stretch_row( $widget ) {

        $widget->start_controls_section(
            'section_stretch_row',
            [
                'label' => esc_html__( 'Stretch Row', 'kera' ),
    ...
    add_action( 'elementor/element/section/section_effects/before_section_start', 'kera_section_stretch_row', 10, 1 );
}

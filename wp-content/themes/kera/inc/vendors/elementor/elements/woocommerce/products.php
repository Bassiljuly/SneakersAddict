...
if ( ! defined( 'ABSPATH' ) || function_exists('Kera_Elementor_Products') ) {
...
class Kera_Elementor_Products extends Kera_Elementor_Carousel_Base {
    ...
    public function get_title() {
        return esc_html__( 'Kera Products', 'kera' );
    }
...
$widgets_manager->register_widget_type(new Kera_Elementor_Products());
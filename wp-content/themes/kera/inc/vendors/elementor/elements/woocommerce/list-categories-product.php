...
if ( ! defined( 'ABSPATH' ) || function_exists('Kera_Elementor_List_Categories_Product') ) {
 ...
 * @since 1.0.0
 */
class Kera_Elementor_List_Categories_Product extends  Kera_Elementor_Carousel_Base{
    /**
     * Get widget name.
     *
    ...
    public function get_title() {
        return esc_html__( 'Kera List Categories Product', 'kera' );
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            'section_general',
            [
                'label' => esc_html__( 'List Categories Product', 'kera' ),
            ]
        );
        $this->add_control(
            'limit',
            [
                'label' => esc_html__('Number of categories', 'kera'),
                'type' => Controls_Manager::NUMBER,
                'description' => esc_html__( 'Number of categories to show ( -1 = all )', 'kera' ),
                'min'  => -1,
                'default' => 6,
            ]
        );
                        ...
                        <?php 
                            ...
                            echo '<div class="cat-content">';
                                ?>
                                    ...
                                    <span class="count-item"><?php echo trim($count).' '. apply_filters( 'kera_tbay_categories_count_item', esc_html__('items','kera') ); ?></span>
                                <?php
...
$widgets_manager->register_widget_type(new Kera_Elementor_List_Categories_Product());

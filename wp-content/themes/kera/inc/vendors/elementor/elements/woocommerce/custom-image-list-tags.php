...
if ( ! defined( 'ABSPATH' ) || function_exists('Kera_Elementor_Custom_Image_List_Tags') ) {
...
class Kera_Elementor_Custom_Image_List_Tags extends Kera_Elementor_Carousel_Base {
    ...
    public function get_title() {
        return esc_html__( 'Kera Custom Image List Tags', 'kera' );
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'tags', 
            [
                'label' => esc_html__( 'List Tags', 'kera' ),
    ...
    protected function register_list_tags_repeater() {
        ...
        if ( is_array($tag_slug) && count($tag_slug) ) {
            ...
            $repeater->add_control(
                ...
                [
                    ...
                    'raw'             => sprintf(__('<strong>There are no tags in your site.</strong><br>Go to the <a href="%s" target="_blank">Tags screen</a> to create one.', 'kera'), admin_url('edit-tags.php?taxonomy=product_tag&post_type=product')),
                    'separator'       => 'after',
        ...
        $repeater->add_control(
            'tag_style',
            [
                'label' => esc_html__('Choose Style', 'kera'),
        ...
        $repeater->add_control(
            'tag_add_link',
            [
                'label' => esc_html__( 'Add Custom Link', 'kera' ),
    ...
    protected function register_button() {
        $this->add_control(
            'show_all',
            [
                'label'     => esc_html__('Button Show All', 'kera'),
                'type'      => Controls_Manager::SWITCHER,
                'default' => 'no',
                'separator' => 'before',
            ]
        ...
        $this->add_control(
            'show_count',
            [
                'label'     => esc_html__('Show Count', 'kera'),
                'description' => esc_html__('Display the product number of the tags', 'kera'),
                'type'      => Controls_Manager::SWITCHER,
                'default' => 'no'
            ]
        ); 
    ...
    public function render_item( $item ) {
        ...
        $tag_name       = $tag->name;
        $tag_count      = kera_get_product_count_of_tags($tag);
...
$widgets_manager->register_widget_type(new Kera_Elementor_Custom_Image_List_Tags());
...
if ( ! defined( 'ABSPATH' ) || function_exists('Kera_Elementor_Button') ) {
 ...
 * @since 1.0.0
 */
class Kera_Elementor_Button extends  Kera_Elementor_Widget_Base{
    /**
     * Get widget name.
     *
    ...
    public function get_title() {
        return esc_html__( 'Kera Button', 'kera' );
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'link_button',
            [
                'label' => esc_html__( 'Link Button', 'kera' ),
        ...
        $this->add_control(
            'add_icon',
            [
                'label' => esc_html__( 'Add Icon', 'kera' ),
...
$widgets_manager->register_widget_type(new Kera_Elementor_Button());

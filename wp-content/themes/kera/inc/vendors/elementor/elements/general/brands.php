...
if ( ! defined( 'ABSPATH' ) || function_exists('Kera_Elementor_Brands') ) {
 ...
 * @since 1.0.0
 */
class Kera_Elementor_Brands extends  Kera_Elementor_Carousel_Base{
    /**
     * Get widget name.
     *
    ...
    public function get_title() {
        return esc_html__( 'Kera Brands', 'kera' );
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'brands',
            [
                'label' => esc_html__( 'Brand Items', 'kera' ),
...
$widgets_manager->register_widget_type(new Kera_Elementor_Brands());

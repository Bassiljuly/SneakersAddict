<?php
if ( ! defined( 'ABSPATH' ) || function_exists('Kera_Elementor_Template') ) {
...
/**
 * Elementor Kera Elementor Template
 *
 ...
 * @since 1.0.0
 */
class Kera_Elementor_Template extends Elementor\Widget_Base{
    ...
    public function get_title() {
        return esc_html__('Kera Template', 'kera');
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'section_template',
            [
                'label' => esc_html__( 'Kera Template', 'kera' ),
            ]
        );
...
$widgets_manager->register_widget_type(new Kera_Elementor_Template());
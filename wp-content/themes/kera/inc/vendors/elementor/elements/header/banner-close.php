...
if ( ! defined( 'ABSPATH' ) || function_exists('Kera_Elementor_Banner_Close') ) {
 ...
 * @since 1.0.0
 */
class Kera_Elementor_Banner_Close extends  Kera_Elementor_Widget_Base{
    /**
     * Get widget name.
     *
    ...
    public function get_title() {
        return esc_html__( 'Kera Banner Close', 'kera' );
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'add_link',
            [
                'label' => esc_html__( 'Add Link', 'kera' ),
        ...
        $this->add_control(
            'close_button',
            [
                'label' => esc_html__( 'Show Close Button', 'kera' ),
                'type' => Controls_Manager::SWITCHER,
                'default' => '',
            ]
        );
    ...
    protected function add_control_link() {
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Add Link Option', 'kera' ),
    ...
    protected function render_item_close_button($_id) {
        ...
        echo '<div class="container"><button data-id="'. esc_attr($_id) .'" id="banner-remove-'. esc_attr($_id) .'" class="banner-remove"><i class="zmdi zmdi-close"></i></button></div>';
        
    }
}
$widgets_manager->register_widget_type(new Kera_Elementor_Banner_Close());

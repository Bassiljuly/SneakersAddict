...
if ( ! defined( 'ABSPATH' ) || function_exists('Kera_Elementor_Wishlist') ) {
...
class Kera_Elementor_Wishlist extends Kera_Elementor_Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Kera Wishlist', 'kera');
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            'section_layout',
            [
                'label' => esc_html__('Wishlist', 'kera'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => [
                    'value' => 'zmdi zmdi-favorite-outline',
        ...
        $this->add_control(
            'show_title_wishlist',
            [
                'label'              => esc_html__('Display Title', 'kera'),
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => esc_html__('My Wishlist','kera'),
                'condition' => [
        ...
        $this->add_control(
            'show_total_wishlist',
            [
                'label'              => esc_html__('Show Total', 'kera'),
                'type'               => Controls_Manager::SWITCHER,
                'default'            => 'yes',
            ]
        );
    ...
    private function register_section_style_icon() {
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .top-wishlist i,
                    {{WRAPPER}} .top-wishlist svg'    => 'background-color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .top-wishlist i:hover,
                    {{WRAPPER}} .top-wishlist svg:hover'    => 'background-color: {{VALUE}}',
                ],
            ]
        );
        $this->end_controls_tab();
    ...
    private function register_section_style_total() {
        ...
        $this->add_control(
            'position_left',
            [
                'label'     => esc_html__('Position Left', 'kera'),
                'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 0,
...
$widgets_manager->register_widget_type(new Kera_Elementor_Wishlist());

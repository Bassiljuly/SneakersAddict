...
if ( ! defined( 'ABSPATH' ) || function_exists('Kera_Elementor_Compare') ) {
...
class Kera_Elementor_Compare extends Kera_Elementor_Widget_Base {
    public function get_name() {
        return 'tbay-compare';
    }

    public function get_title() {
        return esc_html__('Kera Compare', 'kera');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
				...
				'selectors' => [
                    '{{WRAPPER}} .element-btn-compare i,
                    {{WRAPPER}} .element-btn-compare svg' => 'font-size: {{SIZE}}{{UNIT}} !important;',
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            ...
            [
                ...
                'default'            => esc_html__('My Compare', 'kera'),
                'condition' => [
    ...
    private function register_section_style_icon() {
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .element-btn-compare i,
                    {{WRAPPER}} .element-btn-compare svg'    => 'background-color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .element-btn-compare i:hover,
                    {{WRAPPER}} .element-btn-compare svg:hover'    => 'background-color: {{VALUE}}',
                ],
            ]
        );
        $this->end_controls_tab();
...
$widgets_manager->register_widget_type(new Kera_Elementor_Compare());

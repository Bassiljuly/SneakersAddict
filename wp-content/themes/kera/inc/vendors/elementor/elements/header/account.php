...
if ( ! defined( 'ABSPATH' ) || function_exists('Kera_Elementor_Account') ) {
...
class Kera_Elementor_Account extends Kera_Elementor_Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Kera Account', 'kera');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'show_text_account',
            [
                'label'              => esc_html__('Display Text Account', 'kera'),
        ...
        $this->add_control(
            'text_before',
            [
                'label'              => esc_html__('Text Before Login', 'kera'),
        ...
        $this->add_control(
            'text_after',
            [
                'label'              => esc_html__('Text After Login', 'kera'),
                'type'               => Controls_Manager::TEXT,
                'condition'          => [
                    'show_text_account' => 'yes'
                ]        
        ...
        $this->add_control(
            'show_sub_account',
            [
                'label'              => esc_html__('Display Sub Menu', 'kera'),
                'type'               => Controls_Manager::SWITCHER,
                'default' => 'yes',
            ]
        );
        ...
        if (!empty($menus)) {
            $this->add_control(
                'sub_menu_account',
                [
                    'label'        => esc_html__('Choose Menu', 'kera'),
        ...
        $this->add_control(
            'show_popup_login',
            [
                'label'              => esc_html__('Display Popup Login', 'kera'),
                'type'               => Controls_Manager::SWITCHER,
                'default' => 'yes',
            ]
        );
    ...
    protected function register_section_style_icon() {
        ...
        $this->add_control(
            ...
            [
				...
				'selectors' => [
					'{{WRAPPER}} .tbay-login a i, {{WRAPPER}} .tbay-login a svg' => 'font-size: {{SIZE}}{{UNIT}} !important;',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Padding Icon Account', 'kera'),
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .tbay-login a i, {{WRAPPER}} .tbay-login a i'    => 'background-color: {{VALUE}}',
                ],
            ]
        );
    ...
    public function check_login($show_text_account,$text_after,$text_before) {
        if(is_user_logged_in()) {
            ...
            if(!empty($text_before)) {
                ...
                $name = esc_html__('Login Or Register','kera');
            }
        }
...
$widgets_manager->register_widget_type(new Kera_Elementor_Account());

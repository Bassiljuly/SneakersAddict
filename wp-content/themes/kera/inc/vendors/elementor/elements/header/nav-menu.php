...
if ( ! defined( 'ABSPATH' ) || function_exists('Kera_Elementor_Nav_Menu') ) {
...
class Kera_Elementor_Nav_Menu extends Kera_Elementor_Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Kera Nav Menu', 'kera');
    }
    ...
    protected function register_controls() {
        ...
        if (!empty($menus)) {
            $this->add_control(
                ...
                [
                    ...
                    'save_default' => true,
                    'separator'    => 'after',
                    'description'  => sprintf(__('Go to the <a href="%s" target="_blank">Menus screen</a> to manage your menus.', 'kera'), admin_url('nav-menus.php')),
                ]
            );
        } else {
            $this->add_control(
        ...
        $this->add_control(
            'layout',
            [
                'label'              => esc_html__('Layout Menu', 'kera'),
                'type'               => Controls_Manager::SELECT,
                'default'            => 'horizontal',
                'options'            => [
                    'horizontal' => esc_html__('Horizontal', 'kera'),
                    'treeview'   => esc_html__('Tree View', 'kera'),
                ],
        ...
        $this->add_control(
            'hidden_indicator',
            [
                'label'        => esc_html__('Hidden Submenu Indicator', 'kera'),
        ...
        $this->add_control(
            'show_toggle_menu',
            [
                'label' => esc_html__( 'Show Toggle Menu', 'kera' ),
                'type' => Controls_Manager::SWITCHER,
                'condition' => [
                    'layout!' => 'horizontal',
        ...
        $this->add_control(
            'show_canvas_menu',
            [
                'label' => esc_html__( 'Show Canvas Menu', 'kera' ),
                'type' => Controls_Manager::SWITCHER,
                'condition' => [
                    'layout!' => 'horizontal',
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Show Canvas Menu Class', 'kera' ),
    ...
    private function register_section_style_main_menu() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Main Menu', 'kera'),
        ...
        $this->add_control(
            'bg_menu',
            [
                'label'     => esc_html__('Background Color Full', 'kera'),
        ...
        $this->add_responsive_control(
            ...
            [
                'label'     => esc_html__('Horizontal Padding', 'kera'),
        ...
        $this->add_control(
            'no-padding-first-item',
            [
                'label' => esc_html__('No Padding Left First Item', 'kera'),
                'type' => Controls_Manager::SWITCHER,
                'condition' => [
                    'layout' => 'horizontal',
                ],
                'prefix_class' => 'no-padding-left-first-',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                'label'     => esc_html__('Vertical Padding', 'kera'),
                'type'      => Controls_Manager::SLIDER,
                'range'     => [
                    'px' => [
                        'max' => 50,
        ...
        $this->add_responsive_control(
            'menu_space_between',
            [
                'label'     => esc_html__('Space Between', 'kera'),
                'type'      => Controls_Manager::SLIDER,
                'range'     => [
                    'px' => [
                        'max' => 100,
    ...
    private function register_section_style_menu_canvas() {
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Color Icon', 'kera'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
    ...
    private function register_section_style_menu_dropdown() {
        $this->start_controls_section(
            ...
            [
                'label'     => esc_html__('Dropdown', 'kera'),
                'tab'       => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_responsive_control(
            'dropdown_Heading',
            [
                'label'     => esc_html__('Heading sub title megamenu', 'kera'),
                'type'      => Controls_Manager::SLIDER,
                'range'     => [
                    'px' => [
                        'max' => 50,
    ...
    private function register_section_toggle_menu() {
        ...
        $this->start_controls_section(
            'section_toggle_menu',
            [
                'label' => esc_html__( 'Toggle Menu', 'kera' ),
                'condition' => [
                    'show_toggle_menu!' => '',
                    'layout!' => 'horizontal',
                ],
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'justify' => [
                        'title' => esc_html__('Justified', 'kera'),
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__('Font Size Title', 'kera'),
                'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 10,
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__('Line Height Title', 'kera'),
                'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 10,
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__('Font Weight Title', 'kera'),
                'type' => Controls_Manager::SELECT,
				'options' => [
                    '100' => '100',
                    '200' => '200',
        ...
        $this->add_control(
            'toggle_content_menu',
            [
                'label' => esc_html__( 'Toggle content menu', 'kera' ),
                'type' => Controls_Manager::SWITCHER,
        ...
        $this->add_control(
            'ajax_toggle',
            [
                'label' => esc_html__( 'Ajax Toggle Menu', 'kera' ),
                'type' => Controls_Manager::SWITCHER,
                'default' => 'no',
                'description' => esc_html__( 'Show/hidden Ajax Toggle Menu', 'kera' ), 
                'condition' => [
        ...
        $this->add_control(
            'show_content_menu',
            [
                'label' => esc_html__( 'Show content menu', 'kera' ),
                'description' => esc_html__( 'Show content menu on home page', 'kera' ),
                'type' => Controls_Manager::SWITCHER,
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Show Icon', 'kera' ),
                'type' => Controls_Manager::SWITCHER,
            ]
        );
        ...
        $this->add_control(
            ...
            [
				...
				'selectors' => [
                    '{{WRAPPER}} .toggle-menu-title i,
                    {{WRAPPER}} .toggle-menu-title svg' => 'font-size: {{SIZE}}{{UNIT}};',
                ],
                'condition' => [
                    'show_toggle_menu_icon!' => '',
                ],
    ...
    private function register_section_canvas_menu() {
        ...
        $this->start_controls_section(
            'section_canvas_menu',
            [
                'label' => esc_html__( 'Canvas Menu', 'kera' ),
                'condition' => [
                    'show_canvas_menu' => 'yes',
                    'layout!' => 'horizontal',
                ],
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Positioning Content', 'kera'),
                'type' => Controls_Manager::CHOOSE,
                'options' => [
                    'left' => [
                        'title' => esc_html__('Left', 'kera'),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Title Content', 'kera'),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );        
        ...
        $this->add_control(
            'ajax_canvas',
            [
                'label' => esc_html__( 'Ajax canvas Menu', 'kera' ),
                'type' => Controls_Manager::SWITCHER,
                'description' => esc_html__( 'Show/hidden Ajax canvas Menu', 'kera' ), 
                'default' => 'no',
                'condition' => [ 
                    'show_canvas_menu' => 'yes',
                    'layout!' => 'horizontal',
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__('Alignment Title', 'kera'),
                'type' => Controls_Manager::CHOOSE,
                'options' => [
                    'left' => [
                        'title' => esc_html__('Left', 'kera'),
    ...
    private function register_section_style_toggle_menu() {
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Hover Text Color', 'kera'),
                'type'      => Controls_Manager::COLOR,
                'global' => [
                    'default' => Global_Colors::COLOR_TEXT,
                ],
...
$widgets_manager->register_widget_type(new Kera_Elementor_Nav_Menu());

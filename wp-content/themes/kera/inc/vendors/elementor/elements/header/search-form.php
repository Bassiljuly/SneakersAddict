...
if ( ! defined( 'ABSPATH' ) || function_exists('Kera_Elementor_Search_Form') ) {
...
class Kera_Elementor_Search_Form extends Kera_Elementor_Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Kera Search Form', 'kera');
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            'section_layout',
            [
                'label' => esc_html__('Search Form', 'kera'),
            ]
        ); 
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Show Result', 'kera'),
        ...
        $this->add_control(
            'show_image_search',
            [
                'label'   => esc_html__('Show Image of Search Result', 'kera'),
        ...
        $this->add_control(
            'show_price_search',
            [
                'label'              => esc_html__('Show Price of Search Result', 'kera'),
                'type'               => Controls_Manager::SWITCHER,
                'default' => 'yes',
                'condition' => [
                    'search_type' => 'product',
    ...
    protected function register_section_style_search_form() {
        $this->start_controls_section(
            'section_style_icon',
            [
                'label' => esc_html__('Style Search Form', 'kera'),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Border Type', 'kera' ),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    '' => esc_html__( 'None', 'kera' ),
                    'solid' => esc_html__( 'Solid', 'kera' ),
                    'double' => esc_html__( 'Double', 'kera' ),
                    'dotted' => esc_html__( 'Dotted', 'kera' ),
                    'dashed' => esc_html__( 'Dashed', 'kera' ),
                    'groove' => esc_html__( 'Groove', 'kera' ),
                ],
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .tbay-search-form .form-group .input-group' => 'border-color: {{VALUE}};background: {{VALUE}};',
                ],
                'condition' => [
                    'border_style_tbay_search_form!' => '',
                ],
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Border Radius Search Form', 'kera'),
                'type'       => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px' ],
                'selectors'  => [
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Categories Search', 'kera'),
                'type' => Controls_Manager::HEADING,
                'separator'    => 'before',
                'condition' => [
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Button Search', 'kera'),
                'type' => Controls_Manager::HEADING,
                'separator'    => 'before',
            ]
        );
        $this->add_control(
            'padding_btn',
            [
                'label'     => esc_html__('Padding Button Search', 'kera'),
                'type'       => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px' ],
                'selectors'  => [
        ...
        $this->add_control(
            'bg_btn',
            [
                'label'     => esc_html__('Background Button', 'kera'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'bg_btn_hover',
            [
                'label'     => esc_html__('Background Button Hover', 'kera'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'color_icon_btn',
            [
                'label'     => esc_html__('Color Icon Button', 'kera'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Color Icon Button Hover', 'kera'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'color_text_btn',
            [
                'label'     => esc_html__('Color Text Button', 'kera'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Color Text Button Hover', 'kera'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Input Search', 'kera'),
                'type' => Controls_Manager::HEADING,
                'separator'    => 'before',
            ]
        );
        $this->add_control(
            'bg_input',
            [
                'label'     => esc_html__('Background Input Search', 'kera'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'color_input',
            [
                'label'     => esc_html__('Color Input Search', 'kera'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
    ...
    protected function _register_form_search() {
        ...
        $this->add_control(
            'search_type',
            [
                'label'              => esc_html__('Search Result', 'kera'),
                'type'               => Controls_Manager::SELECT,
                'default' => 'product',
                'options' => [
                    'product'  => esc_html__('Product','kera'),
                    'post'  => esc_html__('Blog','kera')
                ]
            ]
        );
        ...
        $this->add_control(
            'autocomplete_search',
            [
                'label'              => esc_html__('Auto-complete Search', 'kera'),
                'type'               => Controls_Manager::SWITCHER,
                'default' => true,
            ]
        );
        $this->add_control(
            'placeholder_text',
            [
                'label'              => esc_html__('Placeholder Text', 'kera'),
                'type'               => Controls_Manager::TEXT,
                'default' => esc_html__('Search for products...','kera'),
            ]
        );
        $this->add_control(
            'vali_input_search',
            [
                'label'              => esc_html__('Text Validate Input Search', 'kera'),
                'type'               => Controls_Manager::TEXT,
                'default' => esc_html__('Enter at least 2 characters','kera'),
            ]
        );
        $this->add_control(
            'min_characters_search',
            [
                'label'              => esc_html__('Search Min Characters', 'kera'),
                'type'               => Controls_Manager::SLIDER,
                'size_units' => ['px'],
                'range' => [
                    'px' => [
        ...
        $this->add_control(
            ...
            [
                'label'              => esc_html__('Max Number of Search Results', 'kera'),
                'type'               => Controls_Manager::SLIDER,
                'size_units' => ['px'],
                'range' => [
                    'px' => [
    ...
    protected function _register_button_search() {
        ...
        $this->add_control(
            'text_button_search',
            [
                'label'              => esc_html__('Button Search Text', 'kera'),
                'type'               => Controls_Manager::TEXT,
                'default' => 'Search',
            ]
        );
        $this->add_control(
            'icon_button_search',
            [
                'label'              => esc_html__('Button Search Icon', 'kera'),
    ...
    protected function _register_category_search() {
        ...
        $this->add_control(
            ...
            [
                'label'              => esc_html__('Enable Search in Categories', 'kera'),
                'type'               => Controls_Manager::SWITCHER,
                'default' => 'yes',
            ]
        );
        $this->add_control(
            ...
            [
                'label'              => esc_html__('Search in Categories Text', 'kera'),
                'type'               => Controls_Manager::TEXT,
        ...
        $this->add_control(
            ...
            [
                'label'              => esc_html__('Show count in Categories', 'kera'),
                'type'               => Controls_Manager::SWITCHER,
                'default' => true,
                'condition' => [
                    'enable_categories_search' => 'yes'
    ...
    public function render_search_form() {
        ...
        $class_active_ajax = kera_switcher_to_boolean($autocomplete_search) ? 'kera-ajax-search' : '';
        ...
        $this->add_render_attribute(
            ...
            [
                ...
                'data-thumbnail' => kera_switcher_to_boolean($show_image_search),
                'data-appendto' => '.search-results-'.$_id,
                'data-price' => kera_switcher_to_boolean($show_price_search),
                        ...
                        <div class="input-group">
                            ...
                            <?php endif; ?>
                                ...
                                <div class="search-results-wrapper">
                                    <div class="kera-search-results search-results-<?php echo esc_attr( $_id );?>" ></div>
                                </div>
...
$widgets_manager->register_widget_type(new Kera_Elementor_Search_Form());

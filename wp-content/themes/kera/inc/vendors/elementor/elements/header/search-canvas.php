...
if ( ! defined( 'ABSPATH' ) || function_exists('Kera_Elementor_Search_Canvas') ) {
...
class Kera_Elementor_Search_Canvas extends Kera_Elementor_Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Kera Search Canvas', 'kera');
    }
    ...
    protected function register_style_search_canvas() {
        ...
        $this->add_control(
            'padding_search',
            [
                'label'     => esc_html__('Padding Icon Search', 'kera'),
...
$widgets_manager->register_widget_type(new Kera_Elementor_Search_Canvas());

...
class Kera_Element_Site_Logo extends Kera_Elementor_Widget_Image {
    ...
    public function get_title() {
        return esc_html__( 'Kera Site Logo', 'kera' );
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'logo_select',
            [
                'label' => esc_html__( 'Image from', 'kera' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'global_logo',
                'options' => [
                    'global_logo' => esc_html__( 'Global Logo', 'kera' ),
                    'customize' => esc_html__( 'Custom Logo', 'kera' ),
                ]
            ]
        );
        ...
        $this->update_control(
            ...
            [
                'default' => 'home', 
                'options' => [ 
                    'none' => esc_html__( 'None', 'kera' ),
                    'home' => esc_html__( 'Home Page', 'kera' ),
                    'custom' => esc_html__( 'Custom URL', 'kera' ),
                ],
            ]
        ); 
    ...
    public function register_style_logo() {
        ...
        $this->add_control(
			'width_logo',
			[
				'label' => esc_html__( 'Max Width', 'kera' ),
    ...
    public static function get_logo_default_image_src() {
        $logo_image = KERA_IMAGES . '/logo.png';
    ...
    protected function get_value() {
        $logo = kera_tbay_get_config('media-logo');
...
$widgets_manager->register_widget_type(new Kera_Element_Site_Logo());
...
class Tbay_Widget_Featured_Video extends Tbay_Widget {
    public function __construct() {
        parent::__construct(
            ...
            'kera_featured_video_widget',
            // Widget name will appear in UI
            esc_html__('Kera Featured Video', 'kera'),
             // Widget description
            array( 'description' => esc_html__( 'Show Featured video', 'kera' ),)
        );
    ...
    public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo  esc_attr($this->get_field_id( 'video_link' )); ?>"><?php esc_html_e('Video link:', 'kera' ); ?></label>
            <br>
            ...
            <br>
            <?php echo esc_html__('Support video from Youtube and Vimeo link. Ex: https://www.youtube.com/watch?v=sd0grLQ4voU', 'kera' ); ?>
        </p>
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id('video_name') ); ?>"><?php esc_html_e('Video name:', 'kera' ); ?></label>
            <br>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id('video_width')); ?>"><?php esc_html_e('Video width:', 'kera'); ?></label>
            <br>

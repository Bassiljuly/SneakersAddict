...
class Tbay_Widget_Single_Image extends Tbay_Widget {
    public function __construct() {
        parent::__construct(
            'kera_single_image',
            esc_html__('Kera Single Image', 'kera'),
            array( 'description' => esc_html__( 'Show single image', 'kera' ), )
        );
    ...
    public function form( $instance ) {
        ...
        <label for="<?php echo esc_attr($this->get_field_id( 'single_image' )); ?>"><?php esc_html_e( 'Image:', 'kera' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'alt' )); ?>"><?php esc_html_e( 'Alt:', 'kera' ); ?></label>

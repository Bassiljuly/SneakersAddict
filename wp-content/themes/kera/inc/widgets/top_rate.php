    ...
    class Tbay_Widget_Top_Rate extends Tbay_Widget {
        public function __construct() {
            parent::__construct(
                ...
                'kera_top_rate_widget',
                // Widget name will appear in UI
                esc_html__('Kera Top Rate', 'kera'),
                // Widget description
                array( 'description' => esc_html__( 'The highest rated posts on your site', 'kera' ), )
            );
        ...
        public function form( $instance ) {
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_id('post_type')); ?>"><?php esc_html_e('Get most rated:', 'kera'); ?></label>
            ...
            <p>
                ...
                <option <?php selected('bayesian_rating', $instance['sort']); ?> value="bayesian_rating"><?php esc_html_e('Overall bayesian rating (score)', 'kera'); ?></option>
                <option <?php selected('rating', $instance['sort']); ?> value="rating"><?php esc_html_e('Average rating', 'kera'); ?></option>
                <option <?php selected('votes', $instance['sort']); ?> value="votes"><?php esc_html_e('Number of votes', 'kera'); ?></option>
                </select>
            </p>
            ...
            <p>
                ...
                <?php esc_html_e('Descending', 'kera'); ?>
                </label>
                ...
                <?php esc_html_e('Ascending', 'kera'); ?>
                </label>
            </p>

            <p>
                <label for="<?php echo esc_attr($this->get_field_id('date_limit')); ?>"><?php esc_html_e('Ignore posts older than:', 'kera'); ?></label>
                <input id="<?php echo esc_attr($this->get_field_id('date_limit')); ?>" name="<?php echo esc_attr($this->get_field_name('date_limit')); ?>" type="text" value="<?php echo esc_attr( $instance['date_limit'] ); ?>" size="3" /> <?php esc_html_e('days', 'kera'); ?>
                <br />
                <small><?php esc_html_e('(0 to ignore date)', 'kera'); ?></small>
            </p>

            <p>
                <label for="<?php echo esc_attr($this->get_field_id('number')); ?>"><?php esc_html_e('Limit:', 'kera'); ?></label>

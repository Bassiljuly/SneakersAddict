...
class Tbay_Widget_Recent_Comment extends Tbay_Widget {
    public function __construct() {
        parent::__construct(
            'kera_recent_comment',
            esc_html__('Kera Recent Comments', 'kera'),
            array( 'description' => esc_html__( 'Show list of recent comments', 'kera' ), )
        );
    ...
    public function form( $instance ) {
        if ( isset( $instance[ 'title' ] ) ) {
            ...
            $title = esc_html__( 'Latest Post', 'kera' );
        }
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'number_comment' )); ?>"><?php esc_html_e( 'Num Comments:', 'kera' ); ?></label>

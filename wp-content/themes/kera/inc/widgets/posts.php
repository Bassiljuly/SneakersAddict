...
class Tbay_Widget_Posts extends Tbay_Widget {
    public function __construct() {
        parent::__construct(
            ...
            esc_html__('Kera Posts', 'kera'),
            // Widget description
            array( 'description' => esc_html__( 'Grid post widget', 'kera' ), )
        );
    ...
    public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'ids' )); ?>"><?php esc_html_e( 'Posts:', 'kera' ); ?></label>
            <br>

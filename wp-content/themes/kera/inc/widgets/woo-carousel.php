...
class Tbay_Widget_Woo_Carousel extends Tbay_Widget {
    public function __construct() {
        parent::__construct(
            'kera_woo_carousel',
            esc_html__('Kera woocommerce Carousel', 'kera'),
            array( 'description' => esc_html__( 'Show list product', 'kera' ), )
        );
    ...
    public function form( $instance ) {
        ...
        ?>
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'title' )); ?>"><?php esc_html_e( 'Title:', 'kera' ); ?></label>
        ...
        <p>
            ...
            ?>
            <label for="<?php echo esc_attr($this->get_field_id( 'categories' )); ?>"><?php esc_html_e( 'Please select category to show:', 'kera' ); ?></label>
            ...
            <?php else: ?>
                ...
                <?php esc_html_e('No woocommerce category found ', 'kera'); ?>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'numbers' )); ?>"><?php esc_html_e( 'Number of products to show:', 'kera' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'types' )); ?>"><?php esc_html_e( 'Type Products:', 'kera' ); ?></label>
            ...
            <?php else: ?>
                ...
                <?php esc_html_e('No choose type product found ','kera'); ?>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'columns' )); ?>"><?php esc_html_e( 'Columns:', 'kera' ); ?></label>
            ...
            <?php else: ?>
                ...
                <?php esc_html_e('No choose columns product found ', 'kera'); ?>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'columns_destsmall' )); ?>"><?php esc_html_e( 'Columns screen desktop small:', 'kera' ); ?></label>
            ...
            <?php else: ?>
                ...
                <?php echo esc_html__('No choose columns desktop small product found ', 'kera'); ?>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'columns_tablet' )); ?>"><?php esc_html_e( 'Columns screen tablet:', 'kera' ); ?></label>
            ...
            <?php else: ?>
                ...
                <?php echo esc_html__('No choose columns table product found ','kera'); ?>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'columns_mobile' )); ?>"><?php esc_html_e( 'Columns screen mobile:', 'kera' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'rows' )); ?>"><?php esc_html_e( 'Rows:', 'kera' ); ?></label>
            ...
            <?php else: ?>
                ...
                <?php esc_html_e('No choose rows product found ','kera'); ?>
        ...
        <p><input id="<?php echo esc_attr($this->get_field_id('navigations')); ?>" name="<?php echo esc_attr($this->get_field_name('navigations')); ?>" type="checkbox" value="1" <?php checked( $navigations ); ?> />
            <label for="<?php echo esc_attr($this->get_field_id('navigations') ); ?>">
                <?php esc_html_e('Show navigations','kera'); ?>
            </label>
        ...
        <p><input id="<?php echo esc_attr($this->get_field_id('paginations')); ?>" name="<?php echo esc_attr($this->get_field_name('paginations')); ?>" type="checkbox" value="1" <?php checked( $paginations ); ?> />
            <label for="<?php echo esc_attr($this->get_field_id('paginations') ); ?>">
                <?php echo esc_html__('Show paginations','kera'); ?>
            </label>
        ...
        <p><input id="<?php echo esc_attr($this->get_field_id('disable_mobile')); ?>" name="<?php echo esc_attr($this->get_field_name('disable_mobile')); ?>" type="checkbox" value="1" <?php checked( $disable_mobile ); ?> />
            <label for="<?php echo esc_attr($this->get_field_id('disable_mobile') ); ?>">
                <?php esc_html_e('Disable mobile','kera'); ?>
            </label>

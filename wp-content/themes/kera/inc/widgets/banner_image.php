...
class Tbay_Widget_Banner_Image extends Tbay_Widget {
    public function __construct() {
        parent::__construct(
            'kera_banner_image',
            esc_html__('Kera Banner Image', 'kera'),
            array( 'description' => esc_html__( 'Show banner image', 'kera' ), )
        );
    ...
    public function form( $instance ) {
        ...
        <label for="<?php echo esc_attr($this->get_field_id( 'banner_image' )); ?>"><?php esc_html_e( 'Image:', 'kera' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id('url')); ?>"><?php esc_html_e('Link banner:', 'kera'); ?></label>
            <br>

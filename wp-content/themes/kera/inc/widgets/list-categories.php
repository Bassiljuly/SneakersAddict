...
class Tbay_Widget_List_Categories extends Tbay_Widget {
    public function __construct() {
        parent::__construct(
            'kera_list_categories',
            esc_html__('Kera Woo List Categories', 'kera'),
            array( 'description' => esc_html__( 'Show list categories', 'kera' ), )
        );
    ...
    public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'numbers' )); ?>"><?php esc_html_e( 'Number of categories to show:', 'kera' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'columns_desktop' )); ?>"><?php esc_html_e( 'Columns screen desktop:', 'kera' ); ?></label>
            ...
            <?php else: ?>
                ...
                <?php esc_html_e('No choose columns desktop product found ', 'kera'); ?>
        ...
        <p>
            ...
            <?php else: ?>
                ...
                <?php esc_html_e('No choose columns desktop small product found ', 'kera'); ?>
        ...
        <p>
            ...
            <?php else: ?>
                ...
                <?php esc_html_e('No choose columns table product found ', 'kera'); ?>

...
class Tbay_PostType_Megamenu {
	...
	?>
		<p class="field-icon-font description description-wide">   
			...
			<br>
			<span><?php printf( __( 'This support display icon from <a href="%s" target="_blank">FontAwsome</a> and <a href="%s" target="_blank">Material Design Iconic</a> and <a href="%s" target="_blank">Linearicons</a> and <a href="%s" target="_blank">simple line icons</a> .    <a href="%s" target="_blank">How to use?</a>', 'tbay-elementor' ), '//fontawesome.com/v4.7.0/icons/','http://zavoloklom.github.io/material-design-iconic-font/icons.html','//fonts.thembay.com/linearicons/','//fonts.thembay.com/simple-line-icons/', '//docs.thembay.com/besa/');?></span>
		</p>

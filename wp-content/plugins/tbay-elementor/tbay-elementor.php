...
define( 'TBAY_ELEMENTOR_VERSION', '1.1.7');
 ...
 *
 */
if ( !class_exists( 'ReduxFramework' ) && file_exists( TBAY_ELEMENTOR_DIR . 'libs/redux/redux-core/framework.php' ) ) {
    require_once( TBAY_ELEMENTOR_DIR . 'libs/redux/redux-core/framework.php' );
    require_once( TBAY_ELEMENTOR_DIR . 'libs/loader.php' ); 
} 
 ...
 *
 */
function tbay_import_init() {
	require TBAY_ELEMENTOR_DIR . 'importer/import.php';
}
add_action( 'init', 'tbay_import_init', 50 );
